---
title: 'fastSF: A parallel code for computing structure functions of homogeneous isotropic turbulence'
...
![A schematic diagram showing the procedure of computing the structure functions using vectorization.\label{Schematic}](Schematic_reduced.png)
